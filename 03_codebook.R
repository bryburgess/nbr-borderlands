...
borderlands_codebook <- tribble(
  ...
  "dev_01_currency_swap_line_extant", "Currency Swap Agreement In Place", "Existance of People's Bank of China currency swap lines per year.", "CFR", "2019", "Y/N Binary", "Stock", "Y", NA,
  "dev_01_currency_swap_usd" , "Currency Swap Agreement Drawn Value", "Maximum amount drawn in USD equivalent from People's Bank of China currency swap lines.", "CFR", "USD 2024 Constant", "Flow", "Y", "Deflated adjustment from CFR estimates.",
  ...
  "dev_03_fdi_usd", "Chinese FDI Value", "Chinese Outward FDI Position", "IMF CDIS", "2009-2024", "USD 2024", "USD 2024 Constant", "Stock", "Y", "Reported FDI from CDIS, less coverage but more reliable.",
  "dev_03_fdi_derived_usd", "Derived Chinese FDI Value", "Derived Chinese Outward FDI Position", "IMF CDIS", "2009-2024", "USD 2024", "USD 2024 Constant", "Stock", "N", "Derived FDI from CDIS, less reliable but better coverage.",
  ...
  "civ_01_united_front_presence", "United Front Presence", "Presence of United Front chapter (Chapters of the Council for the Promotion of the Peaceful Reunification of China).", "Jamestown Foundation", 2019, "Binary Y/N", NA, NA, "Y", "Indicator applied to all years, though data is only contemporary as of 2019.",
